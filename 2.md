...
* Primitive variables store values, not references
* Objects store references, if object a = b and b.var = 5. a.var is 5
...
### keyword `this` works as a reference to the object itself where code is running
